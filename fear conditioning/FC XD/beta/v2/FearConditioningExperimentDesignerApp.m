classdef FearConditioningExperimentDesignerApp < handle
    %
    % Usage:
    %     app.FearConditioningExperimentDesignerApp
    ...
    properties (Constant)
        AppPathBase = {'/FearConditioningExperimentDesigner'};
        AppClass = 'FearConditioningExperimentDesignerApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = FearConditioningExperimentDesignerApp()
        ...
        function startApp(obj)
            ...
            mlock;
            FearConditioningExperimentDesignerApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'FC_Design_v2')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong FC_Design_v2
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'FC_Design_v2').getString, ...
            ...
            if nargout(@FC_Design_v2) == 0
                eval('FC_Design_v2');
            else
                obj.AppHandle = eval('FC_Design_v2');
            end
