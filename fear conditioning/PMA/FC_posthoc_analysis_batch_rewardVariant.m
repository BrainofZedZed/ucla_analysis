...
e.csp = [1;0;0;0;0]; %e_index = 1 %in CSp cueframes
e.csp_shock = [1;0;1;0;0];        % in CSp
e.csp_laser = [1;0;0;1;0];        % in CSp
e.csp_shock_laser = [1;0;1;1;0];  % in CSp

e.csm = [0;1;0;0;0]; %e_index = 5 % in CSm cueframes
e.csm_shock = [0;1;1;0;0];        % in CSm
e.csm_laser = [0;1;0;1;0];        % in CSm
e.csm_shock_laser = [0;1;1;1;0];  % in CSm

e.laser = [2;2;0;0;1]; %e_index = 9 % in laser cueframes
e.shock_laser = [2;2;1;1;0];     % in laser cue frames  % NB: assumes that laser is coincident or precedes shock
e.shock = [2;2;1;0;0];           % in shock cue frames
