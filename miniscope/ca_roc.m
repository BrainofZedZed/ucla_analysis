...
% 2) frlu = frame lookup, generated by  'generatefrlu' func
% 3) 'Behavior' struct from behdepot
% 4) 'Behavior_Filter' struct from behdepot
...
csp_vec = Behavior_Filter.Temporal.csp.EventVector;
csp_vec = csp_vec(2:end);
csm_vec = Behavior_Filter.Temporal.csm.EventVector;
csm_vec = csm_vec(2:end);
csp_frz_vec = Behavior_Filter.Temporal.csp.Freezing.BehInEventVector;
csp_frz_vec = csp_frz_vec(2:end);
csm_frz_vec = Behavior_Filter.Temporal.csm.Freezing.BehInEventVector;
