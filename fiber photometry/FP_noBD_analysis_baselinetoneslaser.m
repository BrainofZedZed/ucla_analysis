...
title('baseline tone2 (12kHz) response -- no laser')
legend('tone1', 'tone2', 'tone3', 'tone4', 'mean');
xlabel('time from tone onset')
savefig('baseline_tones2_noLaser.fig');
...
xticks(xtx2);
xticklabels({'-2','0','2','4','6','8','10', '12'});
title('baseline tone2 (12kHz) response -- laser')
legend('tone1', 'tone2', 'tone3', 'tone4', 'mean');
xlabel('time from tone+laser onset')
savefig('baseline_tones2_Laser.fig');

save('baseline_sig2_laser.mat')
